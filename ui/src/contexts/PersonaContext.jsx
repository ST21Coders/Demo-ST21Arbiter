...
export const PERSONAS = {
  ...
  ciso: {
    ...
    access: ['dashboard', 'findings', 'heatmap', 'actions', 'governance', 'reports', 'audit', 'analyst', 'whatif', 'llm-control', 'pipeline', 'data-grouping', 'mcp-chat', 'integrations', 'token-usage', 'impact-analysis'],
    badge: 'CISO',
