...
export const PERSONAS = {
  ...
  grc: {
    ...
    access: ['dashboard', 'findings', 'heatmap', 'governance', 'reports', 'audit', 'analyst', 'smart-rabbit', 'whatif', 'impact-analysis', 'cmdb-drift'],
    badge: 'GRC',
  ...
  soc: {
    ...
    access: ['dashboard', 'findings', 'heatmap', 'actions', 'reports', 'audit', 'analyst', 'smart-rabbit', 'whatif', 'impact-analysis', 'cmdb-drift'],
    badge: 'SOC',
  ...
  ciso: {
    ...
    access: ['dashboard', 'findings', 'heatmap', 'actions', 'governance', 'reports', 'audit', 'analyst', 'smart-rabbit', 'whatif', 'llm-control', 'pipeline', 'data-grouping', 'config-drift', 'mcp-chat', 'integrations', 'token-usage', 'impact-analysis', 'cmdb-drift'],
    badge: 'CISO',
