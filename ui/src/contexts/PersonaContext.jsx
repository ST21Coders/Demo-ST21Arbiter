...
export const PERSONAS = {
  ...
  ciso: {
    ...
    access: ['dashboard', 'findings', 'heatmap', 'actions', 'governance', 'reports', 'audit', 'analyst', 'whatif', 'llm-control', 'pipeline', 'mcp-chat', 'integrations', 'token-usage', 'impact-analysis', 'cmdb-drift'],
    badge: 'CISO',
